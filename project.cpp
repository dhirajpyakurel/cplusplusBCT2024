...
bool isLoggedIn()
{
    ...
    if(un == username && pw == password) // checks for a student of advanced if both un & username and pw & password are the same or not
    {
        return true;
    }
    else
...
int main()
{
    cout<<"                  ADVANCED COLLEGE OF ENGINEERING      \n\n\n";//comment headline advanced 
    ...
    else if(choice == 2) // if user chooses to login
    {
        ...
        else // if student is already logged in returns true, the dashboard is displayed
        {
